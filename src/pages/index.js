        ...
        <div className="inner">
          ...
          <section className="features">
            <article>
              ...
              <p>
                Come join us for the carnival/festival celebration of the spring
                season with free food, games, and activities. We will be holding
                raffles for prizes as well, so come and have fun with ACU to
            ...
            <article>
              ...
              <p>
                Inspired by the hit show Single's Inferno, come meet our lovely
                E-Board members that will be raffled off for suitors. ACU is
                also excited to host YouTuber Kelly Wakasa as a special guest
                for this event! Come out for a chance to hear him speak and for
                a Q&A panel!
              </p>
              {/* <a href="/#" className="special">
                    Learn more
