  ...
  return (
    <section className="py-20 px-4 text-center relative">
      <div className="container mx-auto max-w-4xl relative z-10">
        ...
        >
          Eboard Applications are now OPEN! Open to freshmen, sophomores, and
          juniors. Due Sunday, Feb 15 at 11:59PM.
        </motion.p>
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse 80% 60% at 50% 50%, rgba(127,29,29,0.2) 0%, rgba(127,29,29,0.1) 30%, rgba(127,29,29,0.03) 50%, transparent 70%)',
        }}
      />
    </section>
  );
